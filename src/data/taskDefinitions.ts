  ...
  mobility: [
    {
      ...
      dimension: 'mobility',
      label: '椅上坐姿稳定',
      prompt: '请坐在稳固椅子上，双脚落地，坐直并保持稳定约10秒。',
    ...
    },
    {
      ...
      dimension: 'mobility',
      label: '椅上坐站',
      prompt: '请双手可扶椅子扶手，从椅子站起，再缓慢坐回；全程只使用这一把椅子。',
      levels: ['独立完成', '借助扶手完成', '需要监护或轻扶', '无法完成'],
    },
    {
      id: 'ZT-03',
      dimension: 'mobility',
      label: '坐姿交替抬膝',
      prompt: '请坐稳后交替抬起左右膝盖，能做几次就做几次，不要离开椅面。',
      levels: ['左右交替稳定', '速度稍慢但可完成', '只能抬起一侧或需提醒', '无法完成'],
    },
    {
      id: 'ZT-04',
      dimension: 'mobility',
      label: '坐姿双臂抬举',
      prompt: '请坐稳，分别把左右手臂抬到肩膀以上，再放下；不需要拿任何物品。',
    ...
    },
    {
      ...
      dimension: 'mobility',
      label: '坐姿手指对合',
      prompt: '请坐稳，用拇指依次触碰同手的食指、中指、无名指和小指，再换另一只手。',
      levels: ['双手动作稳定', '轻微迟缓但可完成', '一侧受限或需提醒', '无法完成'],
    },
  ],
  speech: [
    {
